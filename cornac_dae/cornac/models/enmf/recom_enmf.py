...
class ENMF(Recommender):
    ...
    learner: str, optional, default: 'adagrad'
    ...
    * Chen, C., Zhang, M., Zhang, Y., Liu, Y., & Ma, S. (2020). Efficient neural matrix factorization without sampling for recommendation. 
    ...
    def __init__(
        ...
        self.max_item_pu = 0
        # self.dict_loss = {}  # for plotting training loss curve
        self.seed = seed
    ...
    def fit(self, train_set, val_set=None):
        ...
        self.train_set_dict = {}
        max_item_pu = 0
        for user_idx in train_set.user_indices:
        ...
        #     pickle.dump(self.dict_loss, handle)
        return self
    ...
    def _build_graph(self):
        # import tensorflow.compat.v1 as tf
        # from .ops import loss_fn, train_fn
    ...
    def _fit_tf(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            #         self.batch_size, shuffle=True, binary=True, num_zeros=0
            #     )
            # ):
            ...
            print('loss,loss_no_reg,loss_reg ',
                  loss[0] / ll, loss[1] / ll, loss[2] / ll)
            # self.dict_loss[epoch] = loss[0] / ll
    ...
    def load(model_path, trainable=False):
        ...
        # model.iidW = graph.get_tensor_by_name('iidW:0')
        # model.uidW = graph.get_tensor_by_name('uidW:0')
        # model.H_i = graph.get_tensor_by_name('H_i:0')
        ...
        if item_idx is None:
            ...
            known_item_scores = self.sess.run(
                ...
                feed_dict={
                    ...
                    # self.input_pre:np.arange(self.train_set.num_items),
